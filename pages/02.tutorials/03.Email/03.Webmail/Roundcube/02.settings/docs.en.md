...
### Preferences
The user preferences let you adjust various options and settings that control the behavior and the UI of the webmail application. There are a lot, we will just explained the core ones or the ones that we think need some explanations. To have more information, check the [Roundcube documentation](https://docs.roundcube.net/doc/help/1.1/en_US/settings/preferences.html)
...
![Identities](en/responses_edit.png) From there you can change your responses: their names, their contents, delete them, add new ones.
...
5. **Check code**: the first time you set 2FA on your webmail account, you need to enter the code you get from the 2FA app you use to make sure everything is set up properly. So just enter the code you get here, and click on **Check code**. If everything is fine, you'll get a pop-up window that says **Code OK**. ![2fa ok](en/2fa_ok.png)
